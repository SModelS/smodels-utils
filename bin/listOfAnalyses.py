...
class Lister:
    ...
    def footer ( self ):
        ...
        self.f.write ( "<a name='A3'>(3)</a> Likelihood information for combination of signal regions ('SR comb.'): 'slv1' = a covariance matrix for a simplified likelihood v1. 'slv2' = a covariance matrix plus third momenta for simplified likelihood v2. 'pyhf' = full likelihoods as pyhf json files, 'onnx' = surrogate machine learned models.\n\n" )
