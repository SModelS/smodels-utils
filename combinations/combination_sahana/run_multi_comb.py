...
class SModelsOutput(object):
    def __init__(self, inputfile):
        '''inputfile: slha file for which an smodels output is needed'''
    ...
    def getBestCombination(self, queue):
        ...
        '''main function where you compute the theory pred for the model point, get best combination and run SModelS on the best combination'''
