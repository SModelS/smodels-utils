...
with open('./SUSY-2019-08_likelihoods/BkgOnly.json', 'r') as f:
    bkg = json.load(f)
...
# patch = [{'op': 'add', 'path': '/channels/2/samples/0', 'value': {'data': [1.382418081692375], 'modifiers': [{'data': None, 'type': 'normfactor', 'name': 'mu_SIG'}, {'data': None, 'type': 'lumi', 'name': 'lumi'}], 'name': 'bsm'}},
# {'op': 'add', 'path': '/channels/3/samples/0', 'value': {'data': [7.0027849285625], 'modifiers': [{'data': None, 'type': 'normfactor', 'name': 'mu_SIG'}, {'data': None, 'type': 'lumi', 'name': 'lumi'}], 'name': 'bsm'}},
# {'op': 'remove', 'path': '/channels/4'},
# {'op': 'remove', 'path': '/channels/1'},
# {'op': 'remove', 'path': '/channels/0'}]
