...
- [x] try using expected backgrounds of [aux. table 02](https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-04/tabaux_02.png) : see [ULtab-aux.txt](https://github.com/SModelS/smodels-utils/blob/develop/pyhfintegration/ULtab-aux.txt)
