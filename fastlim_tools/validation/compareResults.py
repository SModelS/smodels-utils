...
def compareFolders(fastlimDir,smodelsDir,ignoreFields,allowedDiff,debug):
    ...
    :fastlimDir: folder containing .sms files generated by Fastlim
    :smodelsDir: folder containing the .sms files generated by SModelS
    :ignoreFields: fields/entries to be ignored when comparing the two files
    :allowedDiff: allowed difference between the two numerical values (in percentage)
    :debug: If True, differences will be printed to the screen
...
if __name__ == "__main__":
    ...
    argparser.add_argument('-diff', help='allowed difference for numerical values', default=0.05)
