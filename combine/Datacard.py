# this is taken from HiggsAnalysis/CombineLimit
...
"""
        ...
        print(
            ...
            "#",
            type(self.rateParamsOrder),
        )
        print(
            "DC.frozenNuisances 	= ",
            self.frozenNuisances,
            "#",
            type(self.frozenNuisances),
        )
        print(
            "DC.systematicsShapeMap = ",
            self.systematicsShapeMap,
            "#",
            type(self.systematicsShapeMap),
        )
        print(
            "DC.systematicsParamMap = ",
            self.systematicsParamMap,
            "#",
            type(self.systematicsParamMap),
        )
...
"""
    ...
    def add_syst_id(self, lsyst):
        if lsyst in list(self.systIDMap.keys()):
            self.systIDMap[lsyst].append(len(self.systs) - 1)
        else:
            self.systIDMap[lsyst] = [len(self.systs) - 1]
