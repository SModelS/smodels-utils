...
#singularity shell -c -B /tmp,/run,/scratch -s /scratch-cbe/users/wolfgan.waltenberger/git/smodels-utils/clip/@@SCRIPT@@ -H /mnt/hephy/pheno/ww/git/em-creator /scratch-cbe/users/wolfgan.waltenberger/container/current.simg
sleep 5
rm $0
