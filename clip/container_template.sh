...
singularity exec --cleanenv --env-file /users/$USER/.containerrc -c -B /groups/hephy,/scratch-cbe/users/$USER:/local/wwaltenberger,/scratch-cbe/users/$USER:/home/walten,/scratch-cbe/users/$USER/tmp:/tmp,/run,/scratch -H /scratch-cbe/users/$USER /scratch-cbe/users/$USER/container/current.simg @@SCRIPT@@
