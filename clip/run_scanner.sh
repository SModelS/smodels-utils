...
singularity shell -c -B /tmp,/run,/scratch -s /mnt/hephy/pheno/ww/git/smodels-utils/combinations/scanner.sh -H /mnt/hephy/pheno/ww/ /mnt/hephy/pheno/current.simg
