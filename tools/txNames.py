...
"""
.. module:: txNames
    :synopsis: some methods around the Tx naming convention, 
               e.g. get a generic Tx name for an EElement
...
def getTx(element):
    """takes Element and returns Tx-Name
  ...
  """
    ...
    Branch1=E.branches[0]
    Branch2=E.branches[1]
    d=E.getEinfo()
    v1=d["vertnumb"][0]
    v2=d["vertnumb"][1]
    p1=d["vertparts"][0]
...
#read branch infortmation
    ...
    # print "v1,v2,p1,p2,b1,b2=",v1,v2,p1,p2,b1,b2,"<br>"
#find SMS
    if b1[0]==1 or b2[0]==1:
        return "bad input"
    if b1[1]==[2] and b2[1]==[2]:
        return getT1(ptsCount(b1[2],b2[2]))
    if (b1[1]==[2,2] or b1[1]==[2,1]) and b2[1]==[2,0]:
        return getT3(ptsCount(b1[2],b2[2]), b2)
    if (b1[1]==[2,2] and b2[1]==[2,2]) or (b1[1]==[2,1] and b2[1]==[2,1]):
        return getT5(ptsCount(b1[2],b2[2]))
    if b1[1]==[1] and b2[1]==[1]:
        return getT2(ptsCount(b1[2],b2[2]))
    if b1[1]==[1,1] and b2[1]==[1]:
        return getT4(ptsCount(b1[2],b2[2]))
        if b1[1]==[1,1] and b2[1]==[1,1]:
