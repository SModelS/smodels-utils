...
echo "starting slha creator for thscpm6 .... "
./slhaCreator.py -t THSCPM6 -a "[[x,x], [x, x, (y, z)]]" --xmin 900. --xmax 2500. --dx 100. --ymin 325. --ymax 2400. --dy 100. --zmin 1e-17 --zmax 2e-15 --dz 10. -lz -n 5000 -8 -p 5
